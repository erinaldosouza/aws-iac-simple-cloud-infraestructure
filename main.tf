/* Define o profider e tsgs defaults para os recursos */
provider "aws" {
  region = var.region
  default_tags {
    tags = {
...
/* Cria um Service ECS no cluster usando as subnets e load balancer criados anteriormente */
module "ecs_service" {
...
/* Cria um security group para permitindo entrada e saida via internet - in/outbound traffic */
